---
title: "More feature engineering examples"
sidebarTitle: "More Examples"
description: "Notebooks covering derived features and materialized views."
layout: wide
---
...
| [Computed columns](/feature-engineering/add-computed-column) | Declare a column from an expression and fill it. |
