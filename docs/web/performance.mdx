...
[Explain Analyze](/search/explain-analyze) walks through a fully worked before/after example, including how `KNNVectorDistance` and `output_batches` change once indexes are in place.

## Where to go next {#where-to-go-next}

<Columns cols={2}>
  <Card title="Explain Analyze" icon="gauge" href="/search/explain-analyze">
    Execute a query and read where the time went.
  </Card>
