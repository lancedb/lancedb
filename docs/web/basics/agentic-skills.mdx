...
It ships as the `lancedb` plugin in
...
The walkthrough above is one pattern. The other has its own tutorial.
...
It is the more interesting pattern. [Branches](/management/table#versioning)
