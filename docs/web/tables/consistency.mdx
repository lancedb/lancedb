...
This setting works for both local ([LanceTable](/management/database#uris)) and remote
...
[Versioning](/management/table#versioning) for the full version and tag workflow.
