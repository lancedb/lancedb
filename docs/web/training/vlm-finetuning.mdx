...
<CardGroup cols={2}>
  ...
  <Card title="UDF registry" icon="code" href="https://github.com/lancedb/tmls-2026-demo/blob/main/vlm/geneva_udfs.py">
  ...
  <Card title="Backfill driver" icon="server" href="https://github.com/lancedb/tmls-2026-demo/blob/main/vlm/backfill_geneva.py">
    Feature materialization for the tiers above.
  </Card>
