...
It is built on top of [Lance](/basics/lance), an open-source lakehouse format designed for multimodal AI data.
...
[contact@lancedb.com](https://www.lancedb.com/contact).
