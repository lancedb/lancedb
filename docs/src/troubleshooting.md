...
* Node @lancedb/lancedb: [LanceQueryBuilder.explainPlan](../js/classes/QueryBase.md#explainplan)

To understand how a query was actually executed, use the analyze_plan method. This executes the query and returns a physical execution plan annotated with runtime metrics including execution time, number of rows processed, I/O stats, and more. This makes it especially helpful for performance tuning and debugging.
...
* Node @lancedb/lancedb: [LanceQueryBuilder.analyzePlan](../js/classes/QueryBase.md#analyzeplan)
