...
async def test_optimize(db_async: AsyncConnection):
    ...
    assert (
        str(stats)
        == "OptimizeStats(compaction=CompactionStats { fragments_removed: 2, fragments_added: 1, files_removed: 2, files_added: 1 }, prune=RemovalStats { bytes_removed: 0, old_versions_removed: 0 })"
    )
