...
def write_schema_for(input_schema: pa.Schema, table_schema: pa.Schema) -> pa.Schema: ...
def coerce_batch(batch: pa.RecordBatch, write_schema: pa.Schema) -> pa.RecordBatch: ...
