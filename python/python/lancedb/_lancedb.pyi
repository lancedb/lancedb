...
class Table:
    ...
    async def merge_insert_explain_plan(
        self, parameters: Dict[str, Any], verbose: bool
    ) -> str: ...
    async def merge_insert_analyze_plan(
        self, data: pa.RecordBatchReader, parameters: Dict[str, Any]
    ) -> str: ...
