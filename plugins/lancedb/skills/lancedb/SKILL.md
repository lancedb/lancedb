...
3. Read the matching language branch before writing or changing code:
   ...
   - Table version history and auditing (both SDKs + REST): `references/table_history.md`
