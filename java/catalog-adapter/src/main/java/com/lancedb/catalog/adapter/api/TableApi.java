...
public interface TableApi {
    ...
    @Operation(
        ...
        tags = { "Table" },
        responses = {
            @ApiResponse(responseCode = "204", description = "All tables deleted")
        }
    )
    @RequestMapping(
    ...
    @Operation(
        ...
        tags = { "Table" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Table list response", content = {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"tables\" : [ \"tables\", \"tables\" ], \"nextToken\" : \"nextToken\" }";
    ...
    default ResponseEntity<Void> v1DatabasesDbNameTablesPost(
        @Parameter(name = "dbName", description = "", required = true, in = ParameterIn.PATH) @PathVariable("dbName") String dbName,
        @Parameter(name = "CreateTableRequest", description = "", required = true) @Valid @RequestBody CreateTableRequest createTableRequest
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> v1DatabasesDbNameTablesTableNameDelete(
        @Parameter(name = "dbName", description = "", required = true, in = ParameterIn.PATH) @PathVariable("dbName") String dbName,
        @Parameter(name = "tableName", description = "", required = true, in = ParameterIn.PATH) @PathVariable("tableName") String tableName
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    @Operation(
        ...
        tags = { "Table" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Table metadata", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = TableMetadata.class))
            })
        }
    )
    @RequestMapping(
    ...
    default ResponseEntity<TableMetadata> v1DatabasesDbNameTablesTableNameGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"schema\" : \"{}\", \"location\" : \"location\", \"version\" : 0 }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    @Operation(
        ...
        tags = { "Table" },
        responses = {
            @ApiResponse(responseCode = "204", description = "Table renamed")
        }
    )
    @RequestMapping(
    ...
    default ResponseEntity<Void> v1DatabasesDbNameTablesTableNameNamePut(
        @Parameter(name = "dbName", description = "", required = true, in = ParameterIn.PATH) @PathVariable("dbName") String dbName,
        @Parameter(name = "tableName", description = "", required = true, in = ParameterIn.PATH) @PathVariable("tableName") String tableName,
        @Parameter(name = "V1DatabasesDbNameTablesTableNameNamePutRequest", description = "") @Valid @RequestBody(required = false) Optional<V1DatabasesDbNameTablesTableNameNamePutRequest> v1DatabasesDbNameTablesTableNameNamePutRequest
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> v1DatabasesDbNameTablesTableNamePut(
        @Parameter(name = "dbName", description = "", required = true, in = ParameterIn.PATH) @PathVariable("dbName") String dbName,
        @Parameter(name = "tableName", description = "", required = true, in = ParameterIn.PATH) @PathVariable("tableName") String tableName,
        @Parameter(name = "TableUpdate", description = "") @Valid @RequestBody(required = false) Optional<TableUpdate> tableUpdate
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
