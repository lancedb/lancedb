...
class TableApiControllerTest {
  ...
  @InjectMocks private TableApiController controller;
  ...
  @Test
  void shouldImplementTableApi() {
    assertTrue(controller instanceof TableApi, "Controller should implement TableApi interface");
  }
  ...
  void shouldReturnEmptyWhenRequestIsNull() {
    TableApiController nullController = new TableApiController(null);
  ...
  void testRequestMapping() {
    assertTrue(
        TableApiController.class.isAnnotationPresent(
    ...
    org.springframework.web.bind.annotation.RequestMapping annotation =
        TableApiController.class.getAnnotation(
            org.springframework.web.bind.annotation.RequestMapping.class);
